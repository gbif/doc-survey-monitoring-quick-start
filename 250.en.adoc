...
If every organism included in terms:eco[eco:targetTaxonomicScope] that was observed during an event was reported, then
term:eco[eco:isTaxonomicScopeFullyReported] = `true`; if not, term:eco[eco:isTaxonomicScopeFullyReported] = `false`.
