...
Percent  vegetation cover: simple percent vegetation cover can be recorded as structured data using the extended measurements or facts extension, 
Verbatim vegetation cover: verbatim vegetation cover information can be captured in eco:verbatimSiteDescriptions, and
